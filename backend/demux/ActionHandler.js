...
const Tweet = require('../api/tweets/tweetsmodel')
const Comment = require('../api/tweets/commentsmodel')
...
class ActionHandler extends AbstractActionHandler {
  ...
  async handleWithState (handle) {
    ...
    const state = { tweet: Tweet, comment: Comment, blockIndexState: BlockIndexState }
    try {
